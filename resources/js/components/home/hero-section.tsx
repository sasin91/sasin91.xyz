                ...
                <div className="max-w-2xl mx-auto lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                    <div className="max-w-xl mt-6 lg:mt-0 xl:col-end-1 xl:row-start-1">
                        <Heading className="max-w-2xl lg:col-span-2 xl:col-auto">
                            Jonas Hansen
                            <br />
                            Experienced developer with expertise across the full stack
                        </Heading>
                        <p className="text-lg leading-6 text-secondary-foreground">
                            <br />
                        </p>
                        <p className="text-lg leading-6 text-secondary-foreground">
                            👋 I'm Jonas, a web developer from Slagelse. I have been working with PHP and Laravel since 2015, and since then have helped develop a ticket agency, a video streaming platform and a recruiting platform.
                        </p>
                        <p className="text-lg leading-6 text-secondary-foreground">
                            I thrive on new and exciting ideas and challenges, and am always ready to learn something new. And recognizes the importance of writing clean and readable code that is easy to maintain.
                        </p>
